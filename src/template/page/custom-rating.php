	  ...
	  <div class="mdl-card mdl-shadow--2dp mdl-cell mdl-cell--12-col mdl-cell--12-col-tablet mdl-cell--12-col-desktop jst-card">
		 <div class="mdl-card__title mdl-card--expand mdl-color--blue-200">
			<h2 class="mdl-card__title-text jst-card-title">
				<?php echo __( 'Custom Rating', 'extensions-for-grifus-rating' ); ?>
			</h2>
		 ...
		 <div class="jst-card-subtitle mdl-card__supporting-text mdl-color-text--grey-600">
			<label class="mdl-checkbox mdl-js-checkbox mdl-js-ripple-effect" for="checkbox-rating">
			  <input type="checkbox" id="checkbox-rating" class="mdl-checkbox__input" <?php echo ( $data['restart-when-add'] ) ? 'checked' : ''; ?>>
			  <span class="mdl-checkbox__label"><?php echo __( 'Restart rating when adding a new movie', 'extensions-for-grifus-rating' ); ?></span>
			</label><br /><br />
			<div class="mdl-card__actions mdl-card--border"></div>
			<?php echo __( 'Restart all IMDB ratings', 'extensions-for-grifus-rating' ); ?>
			<div id="tt4" class="icon material-icons info-icon">info_outline</div>
			<div class="mdl-tooltip mdl-tooltip--large" for="tt4">
			<?php echo __( 'This will reset all IMDB ratings to zero', 'extensions-for-grifus-rating' ); ?>
			</div>
			   ...
			   <div class="custom-fields">
				  <div id="process" class="custom-fields">
					 <div id="film-rating">
						...
						<span class="grifus-span was-done"><?php echo __( 'Rating were restarted', 'extensions-for-grifus-rating' ); ?></span>
						<span class="grifus-span nothing-was-done"><?php echo __( 'All ratings had already been reset', 'extensions-for-grifus-rating' ); ?></span><br />
					 </div>
				  </div>
				  <div class="replace-button">
					 <button id="restart-all-ratings" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent">
						<?php echo __( 'Reset all ratings', 'extensions-for-grifus-rating' ); ?>
					 </button>
				  </div>
			   </div>
			</div>
